    ...
    export default {
        ...
        methods: {
            tambahSepatu: function(){
                ...
                axios.post("http://localhost:3000/shoe", formData, {
                    headers: {
    ...
    <div>
        <div class="container my-2" style="width: 100%;">
            <form class="container bg-light my-5 p-4" style="border: 2px solid black; border-radius: 20px;">
                ...
                <a class="btn btn-secondary text-white mx-2" @click="tambahSepatu">Simpan</a>
